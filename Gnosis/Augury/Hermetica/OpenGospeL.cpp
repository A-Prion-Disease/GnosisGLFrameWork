...
Quad::Quad(GLfloat x, GLfloat y, GLfloat z, GLfloat W, GLfloat H, GLfloat TexID, TextureRect& TSQR){
...
float Y0 = TH * (Height - TSQR.YSlot);
float Y1 = TH * (Height - TSQR.YSlot - 1);
