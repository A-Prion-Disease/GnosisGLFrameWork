...
Quad(GLfloat x, GLfloat y, GLfloat z, GLfloat W, GLfloat H, GLfloat TexID, TextureSquare& TSQR);
	   };	
...
TextureSquare FindTexSqr(std::string TexAtlas, int x, int y, int tileSize);
